...
var kt = ({ base: r = "", routes: e = [], ...t } = {}) => ({
    ...
    async fetch(s, ...n) {
      ...
      for (let [c, u] of o.searchParams) {
        l[c] = l[c] ? [].concat(l[c], u) : u;
      }
      e: try {
        for (let c of t.before || []) {
          if ((a = await c(s.proxy ?? s, ...n)) != null) {
            break e;
          }
        }
      ...
      try {
        for (let c of t.finally || []) {
          a = await c(a, s.proxy ?? s, ...n) ?? a;
        }
      } catch (c) {
        if (!t.catch) {
          throw c;
  ...
  xe = (r = "text/plain; charset=utf-8", e) => (t, s = {}) => {
    if (t === void 0 || t instanceof Response) {
      return t;
    }
...
var Rt = (r = {}) => {
  let {
    ...
    l = (c, u) => {
      for (let [_, k] of Object.entries(u)) {
        k && c.headers.append(_, k);
      }
      return c;
    };
  return {
  ...
  qr = (r) => {
    ...
    return {
      ...
      preflight: (u) => {
        let _ = t(u);
        if (_) {
          return u.preflightCorsHeadersSet = !0, new D(null, _);
        }
      },
      ...
      processRoute: (de, q) => {
        ...
        let $t = async (nt, Zt) => {
            ...
            try {
              ...
              if (Z instanceof je) {
                we = { status: Z.statusCode, body: Z.body };
              } else {
                throw Z;
              }
            }
